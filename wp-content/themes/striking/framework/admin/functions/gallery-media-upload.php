...
function gallery_image_attachment_fields_to_edit($form_fields, $post){
	...
	$form_fields['buttons'] = array( 
		'tr' => "\t\t<tr><td></td><td><input type='button' class='button' onclick='themeImageInsertIntoGallery(".$post->ID.")' value='" . esc_attr__( 'Insert into Gallery' ) . "' /> $delete<input type='hidden' value='".$post->ID."' name='gallery_image_ids[]'></td></tr>\n"
	);
	return $form_fields;
}
