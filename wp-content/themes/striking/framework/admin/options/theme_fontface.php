...
if(isset($_GET['page']) && $_GET['page']=='theme_fontface'){
	if (! function_exists("theme_fontface_fonts_option_process")) {
		function theme_fontface_fonts_option_process($option,$data) {
	...
	if (! function_exists("theme_fontface_add_head")){
		function theme_fontface_add_head(){
			...
			foreach($fonts as $value => $font){
				wp_enqueue_style('font|'.$value , $font['url']);
...
if (! function_exists("theme_fontface_fonts_option")) {
	function theme_fontface_fonts_option($option, $default) {
		$fonts = theme_fontface_getfonts();
...
$options = array(
	...
	array(
		...
		array(
			...
			"process" => "theme_fontface_fonts_option_process",
			"default" => '',
			"type" => "custom"
		),
	array(
